...
urlpatterns = [
    ...
    path('search', views.TagView.as_view({'get': 'search_list_tag'}), name="search_list_tag"),
    path('info/<int:pk>', views.TagAuthenticationView.as_view({'get': 'get_info'}), name="get_info"),
    path('create', views.TagAuthenticationView.as_view({'post': 'create_tag'}),name="create_car" ),
