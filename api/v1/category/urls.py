...
urlpatterns = [
    ...
    path('info/<int:pk>', views.CategoryView.as_view({'get': 'get_info'}), name="get_info"),
    path('create', views.CategoryAuthenticationView.as_view({'post': 'create_category'}),name="create_car" ),
